...
export const mockContracts: PublicContract[] = [
  {
    ...
    supplierAnalysis: 'Dodávateľ AutoCont a.s. (po novom Aricoma Systems a.s.) je etablovanou IT firmou s dlhoročným pôsobením na trhu (od 1994) a významným portfóliom verejných zákaziek v ČR. Spoločnosť je finančne stabilná – v posledných rokoch vykazovala tržby v ráde miliárd Kč ročne a patrí medzi 10 najväčších IT firmy v krajine ￼. Vlastnícka štruktúra je transparentná; skutočnými majiteľmi sú český miliardár Karel Komárek (skupina KKCG) a spoluzakladateľ Igor Rusek, pričom Komárek drží nepriamo väčšinový podiel ￼ ￼. Ani firma, ani majitelia nevystupujú na žiadnych medzinárodných sankčných zoznamoch EÚ, USA či ČR (overené k 2025). Z hľadiska formálnych predpokladov teda AutoCont spĺňa požiadavky pre účasť vo verejnej zákazke spojenej s dotáciou. Napriek týmto pozitívam však analýza odhalila významné rizikové faktory najmä v rovine reputácie a integrity dodávateľa. Firma sa historicky zapojila do kartelovej dohody pri verejnej zákazke (IT projekt v Olomouckom kraji 2011–2012) – český ÚOHS jej za účasť v zakázanej dohode uložil pokutu ~11,4 mil. Kč ￼. AutoCont bol tiež trestne obvinený v súvisiacej kauze pre manipuláciu verejných súťaží (obvinenie vznesené 2015 za zločiny vrátane účasti na organizovanej zločineckej skupine a pletich pri verejnej súťaži) ￼. Tieto konania zatiaľ nie sú právoplatne uzavreté – v roku 2024 súd pre procesné pochybenia zrušil pokuty ÚOHS a vrátil prípad na ďalšie konanie ￼ ￼. Riziko korupcie a neetického správania teda visí nad firmou, hoci tá vinu odmieta a doposiaľ nebola odsúdená. Okrem toho analýza verejných zdrojov poukazuje aj na menšie nedostatky v transparentnosti: v registri zmlúv má AutoCont stovky kontraktov, z ktorých desiatky historicky neuvádzali cenu alebo boli tesne pod limitom pre verejné obstarávanie ￼ ￼. To môže naznačovať účelové delenie zákaziek či obchádzanie súťaže. Celkové zhodnotenie: AutoCont a.s. je po odbornej a finančnej stránke schopným dodávateľom veľkých IT projektov, avšak nesie so sebou reputačnú záťaž v podobe korupčných káuz z minulosti. Pre verejnú zákazku spolufinancovanú dotáciou to znamená zvýšenú pozornosť: hoci formálne môže uchádzač splniť podmienky (keďže nie je pravomocne odsúdený ￼), existuje riziko negatívnej publicity a možných komplikácií v prípade ďalšieho vývoja trestnej kauzy. Nižšie uvádzame identifikované riziká a návrhy opatrení.',
    sector: 'ICT',
