...
export const mockContracts: PublicContract[] = [
  ...
  },
  {
    ...
    supplierAnalyses: `Hochtief CZ a.s. je zavedená stavební společnost s řadou veřejných referencí. Byl několikrát kontrolován bez závažných nálezů. Riziko je střední až nízké.`,
    sector: 'Stavebnictví',
  ...
  },
  {
    ...
    supplierAnalyses: `SOR Libchavy spol. s r.o. je tradiční výrobce autobusů s rozsáhlým portfoliem veřejných zakázek. Je považován za spolehlivého dodavatele. Riziko je minimální.`,
    sector: 'Doprava',
  ...
  supplierAnalyses: `ČEZ Solární, s.r.o. se specializuje na obnovitelné zdroje. V minulosti čelil výtkám k technickým parametrům nabídek, nicméně plnění bylo vždy úspěšné. Riziko je střední.`,
  sector: 'Energetika',
  region: 'Moravskoslezský kraj',
  riskScore: 97,
  status: 'bookmarked',
...
},
{
  ...
  supplierAnalyses: `BioVendor – Laboratorní medicína a.s. je přední dodavatel laboratorní techniky. Byl prověřen v několika zakázkách bez zjištěných pochybení. Riziko je nízké.`,
...
},
{
  ...
  supplierAnalyses: `AVE CZ odpadové hospodářství s.r.o. pravidelně zajišťuje komunální služby pro města a obce. Má zkušenosti i s přeshraničními zakázkami. Riziko je minimální.`,
...
},
{
  ...
  supplierAnalyses: `Alza.cz a.s. rozšiřuje své B2G aktivity, včetně dodávek techniky pro školy. Dosavadní spolupráce byla bez komplikací. Riziko je nízké.`,
  sector: 'Vzdělávání',
  region: 'Ústecký kraj',
  riskScore: 89,
  status: 'active',
...
},
{
  ...
  supplierAnalyses: `Stavby a reality Starý s.r.o. je regionální firma s několika referencemi v oblasti obecních staveb. Kontroly dosud neodhalily závažné chyby. Riziko je nízké.`,
  sector: 'Stavebnictví',
  region: 'Zlínský kraj',
  riskScore: 31,
  status: 'active',
