...
export const mockContracts: PublicContract[] = [
  {
    ...
    supplierAnalysis: `Dodavatel Autocont a.s. má bohaté zkušenosti s digitalizací veřejné správy. V minulosti úspěšně realizoval řadu IT projektů pro krajské nemocnice. Riziko je hodnoceno jako nízké.`,
    sector: 'ICT',
